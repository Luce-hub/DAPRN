...
def process_data(train_file_path, support_file_path, query_file_path, num_classes=10):
    ...
    # 创建DataLoader
    train_input_loader = DataLoader(train_input_tensor, batch_size=15, drop_last=False)
    train_label_loader = DataLoader(train_labels_tensor, batch_size=15, drop_last=False)
    support_input_loader = DataLoader(support_input_tensor, batch_size=15, drop_last=False)
    support_label_loader = DataLoader(support_labels_tensor, batch_size=15, drop_last=False)
    query_input_loader = DataLoader(query_input_tensor, batch_size=15, drop_last=False)
    query_label_loader = DataLoader(query_labels_tensor, batch_size=15, drop_last=False)
...
# 对第1组任务 数据进行处理
train_file_1 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model0\random15_50%\train"
support_file_1 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model1\random15_50%\support"
query_file_1 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model1\random15_50%\query"
...
# 对第2组任务 数据进行处理
train_file_2 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model1\random15_50%\train"
support_file_2 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model2\random15_50%\support"
query_file_2 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model2\random15_50%\query"
...
# 对第3组任务 数据进行处理
train_file_3 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model2\random15_50%\train"
support_file_3 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model0\random15_50%\support"
query_file_3 = r"C:\Users\PC\Desktop\第一篇数据\轴承T_3\model0\random15_50%\query"
...
for epoch_1 in range(epochs):
    ...
    for group_idx, (train_input_loader, train_label_loader, support_input_loader, support_label_loader,
        ...
        for train_input, train_label in zip(train_input_loader, train_label_loader):
            ...
            train_input = torch.reshape(train_input, (15, 1024, 3)).to(torch.float)
        ...
        for support_input, support_label in zip(support_input_loader, support_label_loader):
            ...
            support_input = torch.reshape(support_input, (15, 1024, 3)).to(torch.float)
        ...
        for query_input, query_label in zip(query_input_loader, query_label_loader):
            ...
            query_input = torch.reshape(query_input, (15, 1024, 3)).to(torch.float)
